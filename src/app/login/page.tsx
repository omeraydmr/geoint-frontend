  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.current?.show({
        severity: 'error',
        summary: 'Hata',
        detail: error.message || 'Gecersiz kimlik bilgileri',
        life: 3000
      })
    } finally {
      setLoading(false)
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-72 h-72 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-float" />
          <div className="absolute bottom-20 right-20 w-96 h-96 bg-white rounded-full mix-blend-overlay filter blur-3xl animate-float" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="relative z-10 flex flex-col justify-between p-12 text-white w-full">
          ...
          <div className="max-w-md">
            <h1 className="text-4xl font-bold mb-6 leading-tight font-display">
              Veriyi Stratejiye Donusturun
            </h1>
            <p className="text-white/80 text-lg mb-12">
              Turkiye'nin ilk stratejik istihbarat platformu ile rakiplerinizin
              onune gecin. GEOINT, AI Strateji ve daha fazlasi.
            </p>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">Cografi Istihbarat</h3>
                  <p className="text-white/70 text-sm">
                    81 il, ~970 ilce duzeyinde detayli talep analizi
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">AI Strateji</h3>
                  <p className="text-white/70 text-sm">
                    90 gunluk otomatik stratejiler ve eylem planlari
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg mb-1">Rakip Analizi</h3>
                  <p className="text-white/70 text-sm">
                    Gercek zamanli rakip takibi ve keyword gap analizi
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex items-center gap-3 text-white/70 text-sm">
            ...
            <span>Guvenli ve KVKK Uyumlu</span>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-surface-50 dark:bg-surface-950">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-surface-900 rounded-2xl shadow-premium border border-surface-200 dark:border-surface-700 p-8">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-surface-900 dark:text-surface-100 mb-2 font-display">Hos Geldiniz</h2>
              <p className="text-surface-500 dark:text-surface-400">Hesabiniza giris yapin</p>
            </div>
              ...
              <div className="flex items-center">
                <label className="relative flex items-center cursor-pointer">
                  <input
                    ...
                    disabled={loading}
                  />
                  <div className="w-5 h-5 border-2 border-surface-300 dark:border-surface-600 rounded-md peer-checked:bg-brand-600 peer-checked:border-brand-600 transition-all flex items-center justify-center">
                    {rememberMe && (
                  ...
                  <span className="ml-3 text-sm text-surface-700 dark:text-surface-300">Beni hatirla</span>
                </label>
              </div>
